...
import { Bed, Activity, Users, Zap, TrendingUp, AlertTriangle } from 'lucide-react';
...
export function ResourceDashboard() {
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-gray-900 mb-2 text-2xl font-bold">Resource Allocation Dashboard</h1>
        <p className="text-gray-600">Real-time monitoring of hospital resources and capacity</p>
      </div>

      <div className="mb-6">
        <h2 className="text-gray-900 mb-4 text-lg font-semibold">Bed Capacity</h2>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <Bed className="w-12 h-12 text-blue-600 mx-auto mb-2" />
              <div className="text-gray-900 text-lg font-bold">{mockResources.beds.total}</div>
              <div className="text-gray-600 text-sm">Total Beds</div>
            </div>
            <div className="text-center">
              <div className="text-green-600 text-lg font-bold">{mockResources.beds.available}</div>
              <div className="text-gray-600 text-sm">Available</div>
            </div>
            <div className="text-center">
              <div className="text-red-600 text-lg font-bold">{mockResources.beds.occupied}</div>
              <div className="text-gray-600 text-sm">Occupied</div>
            </div>
            <div className="text-center">
              <div className="text-yellow-600 text-lg font-bold">{mockResources.beds.cleaning}</div>
              <div className="text-gray-600 text-sm">Cleaning</div>
            </div>
          </div>
          <div className="mt-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-700">Overall Utilization</span>
              <span className="text-gray-900 font-semibold">{mockResources.beds.utilization}%</span>
            </div>
      ...
      <div className="mb-6">
        <h2 className="text-gray-900 mb-4 text-lg font-semibold">Staff Availability</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {Object.entries(mockResources.staff).map(([role, data]) => (
            <div key={role} className="bg-white rounded-lg shadow p-6">
              <h3 className="text-gray-900 mb-4 capitalize font-semibold">{role}</h3>
      ...
      <div className="mb-6">
        <h2 className="text-gray-900 mb-4 text-lg font-semibold">Equipment Status</h2>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow p-6 text-white">
        <h2 className="text-lg font-semibold mb-4">Capacity Forecast</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white/10 rounded-lg p-4">
            <div className="text-blue-100 mb-1">Next 4 Hours</div>
            <div className="text-2xl font-bold">+15% Load</div>
            <div className="text-sm text-blue-100 mt-1">Expected increase</div>
          </div>
          <div className="bg-white/10 rounded-lg p-4">
            <div className="text-blue-100 mb-1">Peak Time</div>
            <div className="text-2xl font-bold">2:00 PM</div>
            <div className="text-sm text-blue-100 mt-1">Prepare resources</div>
          </div>
          <div className="bg-white/10 rounded-lg p-4">
            <div className="text-blue-100 mb-1">Recommendation</div>
            <div className="text-2xl font-bold">+5 Staff</div>
            <div className="text-sm text-blue-100 mt-1">For optimal coverage</div>
          </div>
        </div>
      </div>
    </div>
